...
import {RenderOneCard} from "./oneCard.tsx";
import {RenderSlider} from "../../littleComponents/slider/slider.tsx";
            ...
            <main className={style.main__page__main}>
                <div className={style.service}>
                    <div className={style.text}>
                        ...
                        {
                            isLoggedIn ? (
                                <button className={style.take__data}><Link to={'/search'}>Запросить данные</Link></button>
                            ) : (
                                <div></div>
                            )
                        }
